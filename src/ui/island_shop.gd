...
func _physics_process(delta):
	...
	if Input.is_action_just_pressed("ui_left"):
		...
		if GameState.item_count(shop_item.properties.name) > 0:
			...
			if item_name == "wood":
				AudioEngine.play_effect("res://assets/audio/sfx/inventory/wood_inventory.ogg")
			elif item_name == "food":
				AudioEngine.play_effect("res://assets/audio/sfx/inventory/meat_pick_up.ogg")
			elif item_name == "metal":
				AudioEngine.play_effect("res://assets/audio/sfx/inventory/diamond_harvest.ogg")
